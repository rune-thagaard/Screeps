...
var roleBuilder = {
    ...
    /** @param {Creep} creep **/
    run: function(creep, doBuildConstructionSites, energySource: StructureContainer | StructureSpawn) {
        ...
        if(targets.length && doBuildConstructionSites) {
    	    ...
    	    else
    	    {
                ...
                let container: StructureContainer = Game.getObjectById(builderSource);
